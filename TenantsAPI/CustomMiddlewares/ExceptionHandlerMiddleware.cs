...
using System.Net;
using TenantsAPI.Helpers.Models;
using TenantsAPI.Models.DbContexts;

namespace TenantsAPI.CustomMiddlewares
{
    /// <summary>
    ...
    public class ExceptionHandlerMiddleware
    {
        ...
        /// <returns></returns>
        public async System.Threading.Tasks.Task Invoke(HttpContext httpContext, IWebHostEnvironment environment, TenantsAPIDbContext dbContext)
        {
            try
            {
