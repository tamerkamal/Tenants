...
using TenantsAPI.Infrastructure.BaseRepository;
using TenantsAPI.Models.DbContexts;
using TenantsAPI.Models.Entities;
...
namespace TenantsAPI.Infrastructure.UnitOfWork
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        /// </summary>
        public TenantsAPIDbContext Context { get; }
        ...
        public UnitOfWork(TenantsAPIDbContext context, IHttpContextAccessor httpContextAccessor)
        {
